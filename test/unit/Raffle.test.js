    ...
    : describe("Raffle Unit Test", function () {
          ...
          describe("checkUpkeep", function () {
              it("returns false if people haven't sent any ETH", async function () {
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])
                  const { upkeepNeeded } = await raffle.callStatic.checkUpkeep([]) // simulating the call of a function with callStatic
                  assert(!upkeepNeeded)
              })
              ...
              it("returns false if enough time hasn't passed", async () => {
                  ...
                  await network.provider.request({ method: "evm_mine", params: [] }) // same as network.provider.send("evm_mine",[])
          ...
          describe("performUpkeep", function () {
              ...
              it("reverts when checkUpkeep is false", async function () {
                  ...
                  await expect(raffle.performUpkeep([])).to.be.revertedWith(
                      `Raffle__UpkeepNotNeeded(${balance.toString()}, ${players.toString()}, ${state.toString()})`
                  )
              })
          ...
          describe("fulfillRandomWords", function () {
              ...
              it("picks a winner, resets the lottery, and sends money", async function () {
                  ...
                  // We need a "listener" that waits for the event
